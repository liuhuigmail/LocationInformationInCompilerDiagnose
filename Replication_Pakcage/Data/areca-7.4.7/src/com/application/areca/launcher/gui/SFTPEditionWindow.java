...
extends AbstractWindow {
	...
	protected Control createContents(Composite parent) {
		...
		itm2.setLayout(new FillLayout());
		Composite composite = new Composite(itm2, SWT.NONE);
	...
	protected void saveChanges() {
		...
		this.currentPolicy.setLogin(txtLogin.getText());
		this.currentPolicy.setRemoteDirectory(txtRemoteDir.getText());
		this.currentPolicy.setRemotePort(Integer.parseInt(txtPort.getText()));
		this.currentPolicy.setRemoteServer(txtHost.getText());
		this.currentPolicy.setHostKey(txtHostKey.getText());
		this.currentPolicy.setCheckHostKey(chkCheckHostKey.getSelection());
		this.currentPolicy.setUseCertificateAuth(radCertificate.getSelection());
		if (this.currentPolicy.isUseCertificateAuth()) {
			this.currentPolicy.setCertificateFileName(txtPrivateKey.getText());
			this.currentPolicy.setEncryptedCert(chkEncrypedtCert.getSelection());
			this.currentPolicy.setPassword(txtPassphrase.getText());
		} else {
			this.currentPolicy.setPassword(txtPassword.getText());
		}
