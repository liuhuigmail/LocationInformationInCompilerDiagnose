...
public class SavePanel implements Listener {
    ...
    public Composite buildComposite(Composite parent) {
		...
		GridLayout layout1 = new GridLayout(showCancel ? 2 : 1, true);
		...
		btnSave = new Button(composite1, SWT.PUSH);
		...
		if (showCancel) {
		    btnCancel = new Button(composite1, SWT.PUSH);        
