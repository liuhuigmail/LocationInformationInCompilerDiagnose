...
implements TargetActions {
    ...
    public Duplicable duplicate() {
        ...
        FileSystemTarget other1 = (FileSystemTarget)other;
		super.copyAttributes(other1);
		other1.sourcesRoot = sourcesRoot;
		other1.trackSymlinks = trackSymlinks;
		other1.followSubdirectories = followSubdirectories;
		other1.trackEmptyDirectories = trackEmptyDirectories;
		other1.sources = DuplicateHelper.duplicate(sources, false);
        return other;
    }
